...
export const bibliografia: ReferenciaBibliografica[] = [
  ...
  },
  {
    ...
    revista: 'Article acadèmic',
    citacio: 'MEL: Legal Spanish Language Model. (2024). Article acadèmic disponible a la biblioteca del projecte.',
    resum: 'Article sobre MEL, un model de llenguatge especialitzat en dret espanyol. Descrit el desenvolupament, entrenament i avaluació d\'aquest model legal especialitzat, proporcionant insights sobre com crear models d\'IA adaptats a dominis legals específics. MEL exemplifica l\'aproximació de desenvolupar models d\'IA especialitzats per al dret, complementant les idees de López de Mántaras sobre IA especialitzada. El model demostra com els sistemes d\'IA entrenats específicament per a dominis legals poden superar les limitacions dels models generals en tasques de comprensió i generació de llenguatge jurídic.',
    temes: ['IA especialitzada', 'Models de llenguatge', 'Dret espanyol', 'LegalTech', 'NLP legal', 'IA aplicada'],
  ...
  },
  {
    ...
    citacio: 'Codi Ètic d\'Intel·ligència Artificial. (2024). Document disponible a la biblioteca del projecte.',
    resum: 'Document que estableix els principis ètics i les directrius per al desenvolupament i ús responsable de la intel·ligència artificial. Rellevant per al projecte Prudencia.ad en el context de garantir que l\'ús de la IA en l\'àmbit legal compleixi amb estàndards ètics i de responsabilitat. Aquest codi proporciona un marc de referència per al desenvolupament de sistemes d\'IA ètics i responsables en aplicacions legals.',
    temes: ['IA', 'Ètica legal', 'Responsabilitat', 'Regulació', 'Governança', 'Ètica'],
  ...
  },
  {
    ...
    revista: 'Article acadèmic',
    citacio: 'Natural Language Processing for the Legal Domain: A Survey of Tasks, Datasets, Models and Challenges. (2024). Article acadèmic disponible a la biblioteca del projecte.',
    resum: 'Revisió completa sobre el processament de llenguatge natural aplicat al domini legal. Cobreix tasques, conjunts de dades, models i desafiaments específics del domini legal. Proporciona una visió general de l\'estat de l\'art en NLP legal, incloent-hi les aplicacions, limitacions i futures direccions de recerca. Essencial per entendre el context tècnic de l\'aplicació de NLP en sistemes legals.',
    temes: ['NLP', 'LegalTech', 'IA', 'Revisió bibliogràfica', 'Datasets', 'Models', 'NLP legal', 'Processament de llenguatge natural'],
  ...
  },
  {
    ...
    revista: 'Llibre acadèmic',
    citacio: 'Capítol 1: La intel·ligència artificial i responsabilitat civil. (2024). Document disponible a la biblioteca del projecte.',
    resum: 'Capítol d\'un llibre que analitza la responsabilitat civil en el context de la intel·ligència artificial. Explora les implicacions legals de l\'ús de sistemes d\'IA, els criteris d\'atribució de responsabilitat i els mecanismes de compensació per danys causats per IA. Aquest treball proporciona una anàlisi teòrica i pràctica de com el dret de danys s\'adapta a la realitat de la IA.',
    temes: ['IA', 'Responsabilitat civil', 'Dret de danys', 'Regulació', 'Liability'],
    fitxer: 'captulo-1-la-inteligencia-artificial-y-responsabilidad-civil_es.pdf'
  },
  {
    id: 'af-csj-manual',
    tipus: 'informe',
    autors: ['Consell Superior de Justícia d\'Andorra'],
    any: '2024',
    titol: 'Manual del Consell Superior de Justícia',
    citacio: 'Consell Superior de Justícia d\'Andorra. (2024). Manual del Consell Superior de Justícia. Document disponible a la biblioteca del projecte.',
    resum: 'Manual o document del Consell Superior de Justícia d\'Andorra sobre procediments, normativa o guies relacionades amb l\'administració de justícia. Aquest document proporciona informació sobre el funcionament del sistema judicial andorrà i els procediments legals al Principat.',
    temes: ['Andorra', 'Dret andorrà', 'Administració de justícia', 'Manual', 'Procediments'],
  ...
  },
  {
    ...
    revista: 'Article acadèmic',
    citacio: 'Andorra: Llengües i Identitats. (2024). Article acadèmic disponible a la biblioteca del projecte.',
    resum: 'Article que analitza la situació lingüística i identitària d\'Andorra, explorant el multilingüisme i les seves implicacions legals i socials. Rellevant per al projecte Prudencia.ad en el context del suport multilingüe (català, castellà, francès). Aquest treball proporciona context sobre la realitat multilingüe d\'Andorra i com això afecta l\'accessibilitat jurídica.',
    temes: ['Andorra', 'Multilingüisme', 'Llengües', 'Identitat', 'Dret andorrà', 'Accessibilitat jurídica'],
  ...
  },
  {
    ...
    revista: 'Article acadèmic',
    citacio: 'The Concept of Legal Language: What Makes Legal Language \'Legal\'?. (2024). Article acadèmic disponible a la biblioteca del projecte.',
    resum: 'Article acadèmic que explora el concepte de llenguatge legal i les característiques que el diferencien del llenguatge ordinari. Analitza la terminologia, l\'estructura i les funcions del llenguatge jurídic, rellevant per a la comprensió de les dificultats d\'accessibilitat jurídica. Aquest treball fonamenta teòricament per què el llenguatge jurídic és complex i com aquesta complexitat afecta l\'accés a la justícia.',
  ...
  },
  {
    ...
    revista: 'Article acadèmic',
    citacio: 'The Possibility of a Uniform Legal Language at the Interplay of Legal Discourse, Semiotics and Blockchain Networks. (2024). Article acadèmic disponible a la biblioteca del projecte.',
    resum: 'Article acadèmic que explora la possibilitat d\'un llenguatge legal uniforme a través de la intersecció del discurs legal, la semiótica i les xarxes blockchain. Analitza com les tecnologies emergents poden facilitar la creació de sistemes legals més accessibles i estandarditzats. Aquest treball proposa una visió innovadora sobre com la tecnologia pot transformar el llenguatge jurídic per millorar l\'accessibilitat.',
    temes: ['Llenguatge legal', 'Blockchain', 'Semiótica', 'Uniformitat legal', 'Tecnologia', 'Accessibilitat jurídica', 'Llenguatge clar'],
  ...
  {
    id: 'montolio-bayes-2024',
    tipus: 'article',
    autors: ['Montolío Durán, Estrella', 'Bayés Gil, Marc'],
    any: '2024',
    titol: 'L\'estat de la qüestió de la comunicació clara en castellà a Espanya en l\'àmbit jurídic i administratiu',
    revista: 'Article acadèmic',
    citacio: 'Montolío Durán, E., & Bayés Gil, M. (2024). L\'estat de la qüestió de la comunicació clara en castellà a Espanya en l\'àmbit jurídic i administratiu. Article acadèmic disponible a la biblioteca del projecte.',
    resum: 'Article que descriu la situació actual dels processos institucionals dirigits a fer més clara la comunicació en l\'àmbit de l\'Administració a Espanya (i en castellà). L\'article estructura aquest estat de la qüestió des d\'una perspectiva històrica, a partir d\'un eix cronològic, des del qual identifica i descriu les fites que contribueixen a transformar la cultura comunicativa de l\'Administració pública (que inclou l\'Administració de justícia i la tributària). Aquesta manera d\'abordar l\'estat de la qüestió reconeix les iniciatives identificades com a inacabades, parcials i obertes, i permet incorporar l\'evolució dels projectes de comunicació clara en un contínuum d\'actuacions més ampli.',
    temes: ['Llenguatge clar', 'Llenguatge planer', 'Comunicació clara', 'Anàlisi del discurs', 'Discurs juridicoadministratiu', 'Discurs professional', 'Lingüística aplicada', 'Espanya', 'Accessibilitat jurídica'],
    fitxer: 'n82_montolio_bayes_ca.epub'
  },
  {
    id: 'carretero-2024',
    tipus: 'article',
    autors: ['Carretero González, Cristina'],
    any: '2024',
    titol: 'Perspectiva jurídica del derecho a comprender como derecho a recibir comunicaciones comprensibles',
    revista: 'Article acadèmic',
    citacio: 'Carretero González, C. (2024). Perspectiva jurídica del derecho a comprender como derecho a recibir comunicaciones comprensibles. Article acadèmic disponible a la biblioteca del projecte.',
    resum: 'Article que analitza, des d\'una perspectiva jurídica, el dret a comprendre, qüestió en la qual es manquen estudis amb la profunditat necessària. L\'article tracta la diferència entre les paraules comprendre i entendre, i manifesta la preferència per l\'ús de la paraula comprendre quan s\'enunciï com a dret. Exposa diverses expressions d\'aquest dret, tant en l\'àmbit internacional com en el cas espanyol, que denoten l\'interès creixent per la comprensió en les comunicacions emeses pels poders de l\'Estat. Conclou que encara no s\'ha delimitat ni la concreta naturalesa d\'aquest dret ni el seu contingut essencial, més enllà del seu reflex en diferents disposicions i textos de diversa entitat. Finalment, després de determinar la possible naturalesa com a dret constitucional, a més d\'estar comprès en la normativa general, realitza dues propostes: una suggereix quin pot ser el contingut essencial del dret a comprendre; l\'altra consisteix en reformular o concebre el dret a comprendre com un dret a rebre comunicacions comprensibles.',
    temes: ['Dret a comprendre', 'Dret fonamental', 'Contingut essencial', 'Comunicació', 'Llenguatge', 'Llenguatge clar', 'Accessibilitat jurídica', 'Dret constitucional'],
    fitxer: 'n82_carretero_es.epub'
  },
  {
    id: 'pujol-gabernet-2024',
    tipus: 'article',
    autors: ['Pujol Palau, Marta', 'Gabernet Piqué, Anna'],
    any: '2024',
    titol: 'La claredat com a criteri del llenguatge administratiu i jurídic a Andorra',
    revista: 'Article acadèmic',
    citacio: 'Pujol Palau, M., & Gabernet Piqué, A. (2024). La claredat com a criteri del llenguatge administratiu i jurídic a Andorra. Article acadèmic disponible a la biblioteca del projecte.',
    resum: 'Article que resumeix i explica algunes iniciatives que parteixen de l\'objectiu de fer el llenguatge administratiu i jurídic clar i accessible a Andorra. La comunicació clara ha estat sempre un criteri implícit en la tasca d\'assessorament i correcció desenvolupada pel Servei de Política Lingüística del Govern d\'Andorra. Des de finals del segle XX fins a l\'actualitat, també s\'observa una cura especial d\'altres serveis, departaments i institucions per posar el llenguatge administratiu i jurídic a l\'abast de tothom fent-lo clar i accessible. L\'article descriu la creació i el funcionament del Servei de Tràmits, un servei de finestreta única; l\'esforç de l\'Administració de justícia per facilitar eines de comunicació; les disposicions per al procés de digitalització de l\'Administració; les adaptacions a la lectura fàcil d\'alguns textos d\'Afers Socials; i la Llei 6/2024, del 25 d\'abril, de la llengua pròpia i oficial.',
    temes: ['Andorra', 'Política lingüística', 'Comunicació clara', 'Llenguatge jurídic', 'Llenguatge administratiu', 'Legislació lingüística', 'Llenguatge clar', 'Accessibilitat jurídica', 'Dret andorrà'],
  ...
  },
  {
    id: 'compendium',
    tipus: 'paper',
    autors: ['Arnall Duch, Anna'],
    any: '2024',
    titol: 'Compendium de documents jurídics',
    subtitol: 'Tesi doctoral',
    citacio: 'Arnall Duch, A. (2024). Compendium de documents jurídics. Tesi doctoral. Document disponible a la biblioteca del projecte.',
    resum: 'Tesi doctoral de recopilació de documents jurídics rellevants per al projecte, incloent-hi normatives, jurisprudència i documents acadèmics relacionats amb l\'aplicació de la IA en sistemes legals. Obra de recopilació i anàlisi de Anna Arnall Duch.',
    temes: ['Compendi', 'Documents jurídics', 'Recopilació', 'Tesi doctoral'],
